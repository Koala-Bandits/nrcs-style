module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // Copy Stylesheets, fonts, img, and js **FROM** /node_modules/fsa-style/ to **TO** /src
    copy: {
    ...
    uglify: {
      ...
      build: {
        src: 'dist/js/fsa-style-docs.js',
        dest: 'dist/js/fsa-style-docs.min.js'
      },
      demo: {
        src: 'dist/js/fsa-style-demos.js',
        dest: 'dist/js/fsa-style-demos.min.js'
      }
    },
    ...
    browserify: {
      main: {
        files: {
          ...
          'dist/js/fsa-style-demos.js': [
            'src/js/fsa-style-demos.js'
          ],
          // 'dist/js/uswds.js': [
